...
const Hero = () => {
    return (
        <div className="relative flex flex-col md:flex-row items-center justify-center md:min-h-screen p-8 gap-10 md:gap-20 overflow-hidden">
            <motion.div {...heroLeft} className="relative z-20 flex flex-col items-start gap-4 md:w-1/2">
            ...
            <motion.div {...heroRight} className="md:w-1/2 relative z-10 flex items-center justify-center">
